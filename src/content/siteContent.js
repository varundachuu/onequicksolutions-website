export const serviceItems = [
  ...
  },
  {
    ...
    bullets: [
      "Multi-user dashboards and subscription-ready workflows",
      "Feature planning based on business goals and growth stage",
      "Product thinking that supports launch and iteration",
    ],
...
export const processSteps = [
  {
    ...
    description:
      "We start by understanding your business model, operational friction, users, and commercial goals so the solution is shaped around the right problem.",
  },
  {
    step: "02",
  ...
  {
    step: "05",
    title: "QA, Performance & Launch Readiness",
    description:
...
export const technologyGroups = [
  ...
  },
  {
    ...
    chips: ["APIs", "Workflow logic", "Data models"],
  },
  {
    icon: "mobile",
  ...
  },
  {
    ...
    chips: ["Dashboards", "Reporting", "Business intelligence"],
  },
  {
    icon: "ai",
...
export const portfolioStories = [
  ...
  },
  {
    ...
    outcome:
      "The process becomes more consistent, easier to manage, and more transparent for both recruiters and clients.",
  },
  {
